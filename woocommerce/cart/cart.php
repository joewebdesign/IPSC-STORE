  ...
  <table class="shop_table cart" cellspacing="0">
    <thead>
      <tr>
        ...
        <th class="product-name"><?php _e( 'Produs', '__x__' ); ?></th>
        <th class="product-price"><?php _e( 'Pret', '__x__' ); ?></th>
        <th class="product-quantity"><?php _e( 'Cantitate', '__x__' ); ?></th>
      ...
      <tr>
        <td colspan="6" class="actions">
          ...
          <div class="update action-group">
            <input type="submit" class="button" name="update_cart" value="<?php _e( 'Actualizeaza Coş', '__x__' ); ?>" /> <input type="submit" class="checkout-button button alt wc-forward" name="proceed" value="<?php _e( 'Finalizează Comanda', '__x__' ); ?>" />
          </div>
